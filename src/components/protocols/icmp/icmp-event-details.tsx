...
import type { IcmpSimulationStepState } from "@/features/protocols/icmp/icmp.types";

interface IcmpEventDetailsProps {
  stepState?: IcmpSimulationStepState;
}

export function IcmpEventDetails({ stepState }: IcmpEventDetailsProps) {
          ...
          <div className="flex items-center gap-2 text-foreground font-semibold text-xs">
            {pedagogyTrack === "beginner" ? (
              ...
              <>
                ...
                <span>RFC 792 / RFC 1191 Technical Specification</span>
              </>
            )}
          </div>
        ...
        {eventExplanation.fieldsChanged && eventExplanation.fieldsChanged.length > 0 && (
          <div className="space-y-1.5 pt-1">
            <span className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider block">
              Packet & Diagnostics Transformation:
            </span>
